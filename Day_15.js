...
console.log(generateId1()); // Output: 1
console.log(generateId1()); // Output: 2
console.log(generateId1()); // Output: 3
...
const greetJohn = greetUser("Inder !!!!");
greetJohn(); // Output: "Hello, Inder!"
...
ItemCollection.addItem("Radha ");
ItemCollection.addItem("Krishna");
console.log(ItemCollection.listItems()); 
ItemCollection.removeItem("Hare Krishna");
console.log(ItemCollection.listItems()); 
